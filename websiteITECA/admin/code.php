...
if(isset($_POST['add_category_btn']))
{
    ...
    if($cate_query_run)
    {
        ...
        redirect("add-category.php","Category Added Successfull Boss");
    }
    else
    {
...
else if(isset($_POST['add_product_btn']))
{
    ...
    if($name != "" && $slug !="" && $description !="")
    {
        ...
        {
            move_uploaded_file($_FILES['image']['tmp_name'], $path.'/'.$filename);
            redirect("add-product.php", "Product was successfully added");
        }
        else
        {
...
else if(isset($_POST['update_services_btn']))
{
    ...
    {
        redirect("edit-services.php?id=$service_id", "Service Updated Successfully");
    } 
    else 
    {
        redirect("edit-services.php?id=$service_id", "Service Update was unsuccessful");
    }
}
